    ...
    return (
        <StyledSkills>
            ...
            <FlexWrapper wrap={"wrap"} justify={"space-between"}>
                ...
                <Skill iconId={"javaScript"} title={"javascript"} description={"Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua Ut enim"}/>
                ...
                <Skill iconId={"git"} title={"git"} description={"Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua Ut enim"}/>
            </FlexWrapper>
        </StyledSkills>
    );
};
